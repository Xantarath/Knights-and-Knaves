...
function formatReachReminder(
    ...
    if (
        item.twoHandedReachMax !== undefined &&
        item.twoHandedReachMax !== null
    ) {

        text +=
            " (2H: " +
            item.twoHandedReachMax +
            ")";
...
function formatEquipmentReminder(
    item
) {
    ...
    if (
        ...
        // Bucklers deliberately have no Integrity line.
    ...
    // Sidearms do not display a Two-Handed line.
...
function createEquipmentReminderTriggers() {
    ...
    quantityChoices.forEach(
        function (
            ...
            trigger.className =
                "equipment-reminder-trigger";


            trigger.dataset.reminderTrigger =
                "true";
            ...
            trigger.style.left =
                (
                    purchaseButton.offsetLeft +
                    purchaseButton.offsetWidth +
                    8
                ) +
                "px";
            ...
            trigger.style.top =
                purchaseButton.offsetTop +
                "px";


            trigger.style.height =
                purchaseButton.offsetHeight +
                "px";
...
// ========================================================
// PHYSIQUE REMINDER DATA
// ========================================================

const physiqueReminderData = {
...
function createPhysiqueReminderTriggers() {
    ...
    document
        ...
        .forEach(
            function (
                ...
                const physique =
                    purchaseButton.dataset.value;


                const data =
                    physiqueReminderData[
                        physique
                    ];
...
function formatSignedReminderValue(
    value
) {
...
function createHeightReminderTriggers() {
...
function createArmorReminderTriggers() {
                ...
                trigger.addEventListener(
                    ...
                    function (
                        ...
                        const lines = [
                            ...
                            "Mobility: " +
                            formatSignedReminderValue(
                                data.mobilityPenalty
                            ),
    ...
    DESIGN_WIDTH;
        ...
        function calculateCapacity(
            ...
            // ====================================================
            // STOWED SHIELDS + TRUE TWO-HANDED WEAPON CAPACITY
            // ====================================================
            //
        ...
        createEquipmentReminderTriggers();

        createPhysiqueReminderTriggers();

        createHeightReminderTriggers();

        createArmorReminderTriggers();
