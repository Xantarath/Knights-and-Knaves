...
document.addEventListener(
    ...
    // ----------------------------------------------------
    // ABRAZARE: GRAPPLING CANNOT EXCEED 10
    // ----------------------------------------------------
    ...
    if (
        ...
        const strongBonus =
            ...
            candidateState.builder.skills.strong === true
                ? 1
                : 0;
...
function createSkillReminderTriggers() {
    ...
    document
        .querySelectorAll(
            ".toggle-choice[data-key], " +
            ".ranked-choice[data-key]"
        )
        .forEach(
            function (
                purchaseButton
                ...
                // Remove the old browser hover reminder.
                ...
                // Position the reminder area immediately to
                // the right of the associated purchase box.
